...
<html lang="en-US">
    ...
    <body class="{{(Request::is('/') || Request::segment(1) == 'testimonial-deltails') ? 'home page themerex_body fullscreen top_panel_above theme_skin_learnplay' : 'archive category wide theme_skin_kidscare'}}">
        <!--[if lt IE 9]>
